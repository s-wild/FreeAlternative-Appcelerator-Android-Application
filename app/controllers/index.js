...
function userSearch (){ 
	...
	Ti.API.log("user search");

}

// Set up a listener for on key up.
searchInputBox.addEventListener('change', function(e) {
    ...
    timer = setTimeout(userSearch, 500); 
});

function doSearch (searchInput){ 
  Ti.API.log("Do Search Started");
...
// Function to check if premium numbers is in String.
